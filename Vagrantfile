...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "private_network", ip: "172.17.0.30"
  config.vm.synced_folder ".", "/home/core/share", id: "core", nfs: true, mount_options: ['nolock,vers=3,udp']
  #config.vm.synced_folder ".", "/home/core/share", id: "core", type: "rsync", rsync__exclude: ".git/", mount_options:  ['nolock,vers=3,udp']
  #config.vm.synced_folder ".", "/home/core/share", id: "core", type: "rsync", rsync__auto: "true", rsync__exclude: ".git/"
